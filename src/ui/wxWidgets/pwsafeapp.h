...
// RCS-ID:
// Copyright:   Copyright (c) 2003-2015 Rony Shapiro <ronys@users.sourceforge.net>
// Licence:
/////////////////////////////////////////////////////////////////////////////
...
////@end PwsafeApp member variables
 ...
 public:
    ...
    uint32 GetHashPasses() const {return m_core.GetHashPasses();}
    void SetHashPasses(uint32 value) {m_core.SetHashPasses(value);}
    uint32 GetHashMemKiB() const {return m_core.GetHashMemKiB();}
    void SetHashMemKiB(uint32 value) {m_core.SetHashMemKiB(value);}
