...
////@begin COptions member function declarations
  ...
  int GetHashPassesSlider() const { return m_hashPassesSlider ; }
  void SetHashPassesSlider(int value) { m_hashPassesSlider = value ; }

  int GetHashMemKiBSlider() const { return m_hashMemKiBSlider ; }
  void SetHashMemKiBSlider(int value) { m_hashMemKiBSlider = value ; }
...
private:
  ...
  bool m_escexits;
  int m_hashPassesSlider;
  int m_hashMemKiBSlider;
  int m_inittreeview;
