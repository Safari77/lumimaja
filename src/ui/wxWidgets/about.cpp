...
void CAbout::CreateControls()
{
  ...
  wxStaticText* copyrightStaticText = new wxStaticText(aboutDialog, wxID_STATIC, _("Copyright © 2003-2015 by Rony Shapiro, 2015 by Sami Farin"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
