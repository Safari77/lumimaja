...
void CAbout::CreateControls()
{
  ...
  wxStaticText* copyrightStaticText = new wxStaticText(aboutDialog, wxID_STATIC, _("Copyright © 2003-2016 by Rony Shapiro, 2015-2021 by Sami Farin"), wxDefaultPosition, wxDefaultSize, wxALIGN_LEFT);
